...
public class TranslitCyrillic {
	   private static final HashMap<Character, String> charMap = new HashMap<Character, String>();
	   private static final HashMap<Character, String> charMapFS;
	    ...
	    static {
	        ...
	        charMapFS = (HashMap<Character, String>) charMap.clone();
	        charMapFS.put(' ', "_");
	        charMapFS.put('*', "_");
	        charMapFS.put('?', "_");
	        charMapFS.put('!', "_");
	    ...
	    public static String transliterate_filesystem(String string) {
	        StringBuilder transliteratedString = new StringBuilder();
	        String charFromMap;
	        for (int i = 0; i < string.length(); i++) {
	            Character ch = string.charAt(i);
            	charFromMap = charMapFS.get(ch);
	            if (charFromMap == null) {
	                transliteratedString.append(ch);
	            } else {
	                transliteratedString.append(charFromMap);
